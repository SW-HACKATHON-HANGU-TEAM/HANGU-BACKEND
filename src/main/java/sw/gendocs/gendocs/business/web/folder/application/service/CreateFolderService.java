...
import sw.gendocs.gendocs.business.core.domain.folder.infrastructure.command.SubFolderJpaRepository;
...
public class CreateFolderService {
    ...
    private final SubFolderJpaRepository subFolderJpaRepository;
